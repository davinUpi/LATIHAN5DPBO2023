...
public class Menu extends javax.swing.JFrame {
    ...
    private int selectedID = -1; // dipake ketika memilih satu data di dalam database
    ...
    public final DefaultTableModel setTable(){
            Object[]  column = {"NIM", "Nama", "Gender", "Nilai"};
    ...
    public void insertData() {
        ...
        // Show Information
        System.out.println("Inser succ");
        JOptionPane.showMessageDialog(null, "Data berhasil di up!");
    }
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                        .addComponent(maleRadio, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(femaleRadio, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(btnAdd)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (isUpdate == false){
            if(
                (fieldNim.getText().equals("")) ||
                (fieldNama.getText().equals("")) ||
                (fieldNilai.getText().equals("")) ||
                ((maleRadio.isSelected() == false) && (femaleRadio.isSelected() == false))
            ){
    ...
    private void tblMhsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMhsMouseClicked
        ...
        String selectedGender = (tblMhs.getModel().getValueAt(row,2).toString());
        String selectedNilai = (tblMhs.getModel().getValueAt(row, 3).toString());
        // Search Data
        for (int i = 0 ; i < listMhs.size(); i++){
